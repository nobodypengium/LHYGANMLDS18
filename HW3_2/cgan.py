...
class CGAN():
    ...
    def train(self, X_train, y_train, epochs=20000, batch_size=128):
        ...
        for epoch in range(epochs):
            ...
            if epoch % 1000 == 0:
                self.generator.save('data/models/CGAN/g/{}.h5'.format(epoch))
                # self.combined.save('data/models/CGAN/gd/{}.h5'.format(epoch))
